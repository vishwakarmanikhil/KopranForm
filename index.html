        ...
        <div class="container">
            ...
            <form method="post" id="tds_tcs_form">
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-user-type">
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-user-pan">
                                    <div class="form-check">                                  
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-turnover-2021">
                                    <div class="form-check">                                  
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-ROI-2021">
                                    <div class="form-check">                                  
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name="ack_number_current20_21">
                                </div>
                            </div>                       
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <input type="file" class="form-control" name="proof_file_current20_21">
                                </div>
                            </div>                       
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-turnover-1920">
                                    <div class="form-check">                                  
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-ROI-1920">
                                    <div class="form-check">                                  
                                      <label class="form-check-label" for="show_ROIprevious">
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <input type="text" class="form-control" name="ack_number_previous19_20">
                                </div>
                            </div>                       
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="form-item">
                            <div class="row">
                                ...
                                <div class="col-7">
                                    <input type="file" class="form-control" name="proof_file_previous19_20">
                                </div>
                            </div>                       
                        </div>
                    </div>
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-tdstcs-2021">
                                    <div class="form-check">                                  
                                      <label class="form-check-label" for="tds_tcs1_current">
                                        <input class="form-check-input" type="radio" name="tdstcs_20_21" id="tds_tcs1_current" value="1"> Yes
                                      </label>
                                    </div>
                                    <div class="form-check">                                  
                                      <label class="form-check-label" for="tds_tcs2_current">
                                        <input class="form-check-input" type="radio" name="tdstcs_20_21" id="tds_tcs2_current" value="0"> No
                                      </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            ...
                            <div class="col-7">
                                <div class="error-placement-tdstcs-1920">
                                    <div class="form-check">                                  
                                      <label class="form-check-label" for="tds_tcs1">
                                        <input class="form-check-input" type="radio" name="tdstcs_19_20" id="tds_tcs1_old" value="1"> Yes
                                      </label>
                                    </div>
                                    <div class="form-check">                                  
                                      <label class="form-check-label" for="tds_tcs2">
                                        <input class="form-check-input" type="radio" name="tdstcs_19_20" id="tds_tcs2_old" value="0"> No
                                      </label>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="form-group">
                    <div class="form-item">
                        <div class="row">
                            <div class="error-placement-accept">
                                <div class="form-check">
